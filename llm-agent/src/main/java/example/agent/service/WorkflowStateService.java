...
public class WorkflowStateService {
    ...
    public List<String> getCurrentProcesses() { return currentProcesses; }
    public String getPersonaTemplate() { return personaTemplate; }
    public Map<String, List<String>> getDependencyRules() { return dependencyRules; }
    ...
    public void updateWorkflow(List<String> newProcesses, String newPersonaTemplate, String dependencies, String openingMonologue) {
        if (newProcesses != null) this.currentProcesses = new ArrayList<>(newProcesses);
        if (newPersonaTemplate != null && !newPersonaTemplate.trim().isEmpty()) { this.personaTemplate = newPersonaTemplate; }
        if (openingMonologue != null) { this.openingMonologue = openingMonologue; }

...
import org.example.mcp.dto.Plan; // <-- 新增导入
...
//        try {
//            // --- 修改点 1: 增加对比较结果是否为空的判断 ---
//            Map<String, Plan> result = planService.compareTwoPlans(planName1, planName2);
//            if (result.isEmpty()) {
//                log.warn("ToolService: PlanService未能找到任何要比较的套餐: '{}', '{}'。", planName1, planName2);
//                return String.format("{\"error\": \"未找到任何名为 '%s' 或 '%s' 的套餐用于比较。\"}", planName1, planName2);
//            }

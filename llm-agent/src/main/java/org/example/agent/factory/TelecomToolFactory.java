...
//                .description("【仅当用户明确表示要比较两个套餐时】才调用此工具。例如当用户问'新旧套餐有什么区别'、'哪个更划算'，或在对话中同时提到新旧套餐的优劣时。此工具会返回两个套餐的详细数据供你分析。")
...
//                "planName1", ParameterProperty.builder().type("string").description("第一个套餐的完整名称，必须是 '用户原套餐' 或 '升档新套餐' 中的一个。").build(),
//                "planName2", ParameterProperty.builder().type("string").description("第二个套餐的完整名称，必须是 '用户原套餐' 或 '升档新套餐' 中的一个。").build()
//        );
//
